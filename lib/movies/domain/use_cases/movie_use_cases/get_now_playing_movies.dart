...
class GetNowPlayingMovies extends BaseUseCases<List<Movie>,Parameters>{
  final BaseMoviesRepository _baseMoviesRepository;
  GetNowPlayingMovies(this._baseMoviesRepository);

  @override
  Future<Either<Failure, List<Movie>>> call({required Parameters numOfPage})=> _baseMoviesRepository.getNowPlaying(page: numOfPage.page);
