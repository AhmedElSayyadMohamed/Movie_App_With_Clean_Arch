...
class MovieTrialWidget extends StatefulWidget {
  const MovieTrialWidget({super.key});
...
class _MovieTrialWidgetState extends State<MovieTrialWidget> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.networkUrl(Uri.parse('https://www.youtube.com/watch?v=naQr0uTrH_s'));

    _controller.addListener(() {
      setState(() {});
    });
    _controller.setLooping(true);
    _controller.initialize().then((_) => setState(() {})).catchError((error){log(error);});
    _controller.play();
  }
